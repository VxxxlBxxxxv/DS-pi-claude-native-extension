...
|-------|------|-------|-------|
| `verifier` | R23 — formal checklist verification, context isolation | `openai-codex/gpt-5.3-codex-spark` (WP-88 Haiku replacement; swap = edit one frontmatter line) | read-only |
